...
public class DashboardQuery {
    ...
    public final static String DELETE_RECOMMEND_RESULT = """
            ...
            where FROM_PAYER_ACCOUNT IN (select PAYER_ID from cmp_admin.x_account_info where SITE_ID = ?)
            or TO_PAYER_ACCOUNT IN (select PAYER_ID from cmp_admin.x_account_info where SITE_ID = ?)
            """;
    ...
    public final static String INSERT_ACCOUNT_INFO = """
            insert into cmp_admin.x_account_info (PAYER_NAME, SITE_ID, 
                            CMPN_ID, CMPN_NM,
                            PAYER_ID, TARGET_COV, FIX_YN,
